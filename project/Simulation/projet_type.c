...
{
    *(SSM_ST_SM1*)pValue = SSM_st_open_door_SM1;
    return 1;
}
...
static SimEnumValUtils SSM_TR_SM1_values[] = {
    ...
    { "SSM_TR_no_trans_SM1", SSM_TR_no_trans_SM1},
    { "SSM_TR_open_door_State4_1_open_door_SM1", SSM_TR_open_door_State4_1_open_door_SM1},
    { "SSM_TR_open_door_State4_1_open_door_SM1", SSM_TR_open_door_State4_1_open_door_SM1},
    { "SSM_TR_close_door_Intermediate1_1_close_door_SM1", SSM_TR_close_door_Intermediate1_1_close_door_SM1},
    { "SSM_TR_close_door_Intermediate1_1_close_door_SM1", SSM_TR_close_door_Intermediate1_1_close_door_SM1},
    { "SSM_TR_Intermediate1_open_door_1_Intermediate1_SM1", SSM_TR_Intermediate1_open_door_1_Intermediate1_SM1},
    { "SSM_TR_Intermediate1_open_door_1_Intermediate1_SM1", SSM_TR_Intermediate1_open_door_1_Intermediate1_SM1},
    { "SSM_TR_State4_close_door_1_State4_SM1", SSM_TR_State4_close_door_1_State4_SM1},
    { "SSM_TR_State4_close_door_1_State4_SM1", SSM_TR_State4_close_door_1_State4_SM1},
};
