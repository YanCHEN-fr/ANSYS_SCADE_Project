#ifndef RISING_FALLING_EDGE_DETECTOR_TYPES_CONVERSION
#define RISING_FALLING_EDGE_DETECTOR_TYPES_CONVERSION
...
#endif /*RISING_FALLING_EDGE_DETECTOR_TYPES_CONVERSION */
